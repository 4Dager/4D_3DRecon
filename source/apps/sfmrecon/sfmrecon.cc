...
main (int argc, char** argv)
{
    ...
    util::system::print_build_timestamp("CGAII SfM Reconstruction");
    ...
    args.set_description("Reconstruction of camera parameters "
        "for CGAII scenes using Structure from Motion. Note: The "
    ...
    args.add_option('\0', "intrinsics-from-views", false, "Use intrinsics from CGAII views [use EXIF]");
